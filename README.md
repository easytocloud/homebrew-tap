...
| [codeartifact-uv](https://github.com/easytocloud/codeartifact-uv)                         | Automatically update uv config to use codeartifact                               | `brew install codeartifact-uv`             |
| [codecommit-utils](https://github.com/easytocloud/codecommit-utils)                       | Brings gh-style shorthand to aws codecommit repositories and pull requests       | `brew install codecommit-utils`            |
